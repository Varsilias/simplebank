...
// Source: github.com/varsilias/simplebank/db/sqlc (interfaces: Store)
//
...
func (m *MockStore) DeleteEntry(ctx context.Context, id int32) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) DeleteTransfer(ctx context.Context, id int32) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetAccountByPublicId(ctx context.Context, publicID string) (db.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetAccountByUserId(ctx context.Context, userID int32) (db.Account, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) GetAccountByUserId(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAccountByUserId", reflect.TypeOf((*MockStore)(nil).GetAccountByUserId), ctx, userID)
}
...
func (m *MockStore) GetAllUserAccounts(ctx context.Context, userID int32) ([]db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllUserAccounts", ctx, userID)
	ret0, _ := ret[0].([]db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) GetAllUserAccounts(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllUserAccounts", reflect.TypeOf((*MockStore)(nil).GetAllUserAccounts), ctx, userID)
}
...
func (m *MockStore) GetEntryByAccountId(ctx context.Context, accountID int32) (db.Entry, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetEntryByAccountId", ctx, accountID)
	ret0, _ := ret[0].(db.Entry)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) GetEntryByAccountId(ctx, accountID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetEntryByAccountId", reflect.TypeOf((*MockStore)(nil).GetEntryByAccountId), ctx, accountID)
}
...
func (m *MockStore) GetTransferByFromAccountId(ctx context.Context, fromAccountID int32) (db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTransferByFromAccountId", ctx, fromAccountID)
	ret0, _ := ret[0].(db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) GetTransferByFromAccountId(ctx, fromAccountID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTransferByFromAccountId", reflect.TypeOf((*MockStore)(nil).GetTransferByFromAccountId), ctx, fromAccountID)
}

// GetTransferByToAccountId mocks base method.
func (m *MockStore) GetTransferByToAccountId(ctx context.Context, toAccountID int32) (db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTransferByToAccountId", ctx, toAccountID)
	ret0, _ := ret[0].(db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) GetTransferByToAccountId(ctx, toAccountID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTransferByToAccountId", reflect.TypeOf((*MockStore)(nil).GetTransferByToAccountId), ctx, toAccountID)
}
...
// ListEntriesForAccountId mocks base method.
func (m *MockStore) ListEntriesForAccountId(ctx context.Context, arg db.ListEntriesForAccountIdParams) ([]db.Entry, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListEntriesForAccountId", ctx, arg)
	ret0, _ := ret[0].([]db.Entry)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListEntriesForAccountId indicates an expected call of ListEntriesForAccountId.
func (mr *MockStoreMockRecorder) ListEntriesForAccountId(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListEntriesForAccountId", reflect.TypeOf((*MockStore)(nil).ListEntriesForAccountId), ctx, arg)
}
...
// ListTransfersForFromAccountId mocks base method.
func (m *MockStore) ListTransfersForFromAccountId(ctx context.Context, arg db.ListTransfersForFromAccountIdParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListTransfersForFromAccountId", ctx, arg)
	ret0, _ := ret[0].([]db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListTransfersForFromAccountId indicates an expected call of ListTransfersForFromAccountId.
func (mr *MockStoreMockRecorder) ListTransfersForFromAccountId(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListTransfersForFromAccountId", reflect.TypeOf((*MockStore)(nil).ListTransfersForFromAccountId), ctx, arg)
}

// ListTransfersForToAccountId mocks base method.
func (m *MockStore) ListTransfersForToAccountId(ctx context.Context, arg db.ListTransfersForToAccountIdParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListTransfersForToAccountId", ctx, arg)
	ret0, _ := ret[0].([]db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListTransfersForToAccountId indicates an expected call of ListTransfersForToAccountId.
func (mr *MockStoreMockRecorder) ListTransfersForToAccountId(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListTransfersForToAccountId", reflect.TypeOf((*MockStore)(nil).ListTransfersForToAccountId), ctx, arg)
}
